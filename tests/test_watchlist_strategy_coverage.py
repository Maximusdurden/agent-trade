...
# exercises ensure_active_strategy's missing_rule path which logs an ERROR that
# would otherwise file a real Jira bug ticket.
os.environ["DATABASE_FILENAME"] = "test_watchlist_strategy_coverage.db"
