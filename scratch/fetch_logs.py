# filename: fetch_logs.py (repurposed for JIRA transitions)
import os
import sys
...
def run():
    print("Initializing JIRA IssueManager...")
    ...
    comment = (
        ...
        "* *Portfolio Verification*: Confirmed that the Cloud Run Job restored the original **$75k SOL/USD portfolio** (Account Balance: Equity: $75,011.34 | Cash: $61,487.13).\n"
